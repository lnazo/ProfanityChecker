def profanity_checker(sentence):
	new_sentence = ""
	profane_words = {
	"4r5e",
	"5h1t",
	...
	"xrated",
	"xxx"
	} #taken from Google's former What Do You Love (WDYL) project; better to use api here
...
def remove_punctuation(punc):
	punctuation = ['!','.',':', '?']
	print("".join(c for c in punc if c not in punctuation))
